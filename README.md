...
Models and code for the automated detection of gold mines in Sentinel-2 satellite imagery; a web map of gold mines in the Amazon rainforest; links to journalism using this work.
