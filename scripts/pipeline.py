...
def cmds_publish(_periods: Sequence[str]) -> List[str]:
    ...
    return [
        ...
        "#",
        "#    They expire, and 1.4 GB is long enough to outlive them. If the",
        "#    upload dies with an auth error, re-copy the block and re-run: sync",
        "#    compares size and mtime, so it resumes instead of restarting.",
        "#",
